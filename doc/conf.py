...
'''ftrack-connect-nuke-publish documentation build configuration file.'''
...
project = u'ftrack-connect-nuke-publish'
...
with open(
    os.path.join(
        ...
        'ftrack_connect_nuke_publish', '_version.py'
    )
) as _version_file:
    _version = re.match(
